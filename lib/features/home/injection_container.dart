...
Future<void> getTripsModule() async {
  /// Use Cases
  sl.registerLazySingleton<GetTripsUseCase>(() => GetTripsUseCase(sl<BaseTripsRepository>()));
  ...
  /// Data Sources
  sl.registerLazySingleton<HomeRemoteDataSource>(() => HomeRemoteDataSource(sl<ApiConsumer>()));
