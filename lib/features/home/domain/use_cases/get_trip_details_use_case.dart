...
class GetTripDetailsUseCase extends BaseUseCase<BaseResponse<TripModel>, GetTripDetailsParams> {
  final BaseTripsRepository repository;

  GetTripDetailsUseCase(this.repository);

  @override
  Future<Either<Failure, BaseResponse<TripModel>>> call(GetTripDetailsParams parameters) {
    return repository.getTripDetails(parameters);
  }
}
