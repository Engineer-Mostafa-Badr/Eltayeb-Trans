...
class ProfileRemoteDataSource extends BaseProfileRemoteDataSource {
  ...
  Future<BaseResponse<UserModel>> getProfile() async {
    final response = await _apiConsumer.get(EndPoints.profile, authenticated: true);
  ...
  @override
  Future<BaseResponse<UserModel>> updateProfile(UpdateProfileParams parameters) async {
